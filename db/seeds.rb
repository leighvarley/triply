...
Lindsey = User.create!(username: "lindseydortch", password_digest: "ashevilleawesome")
Grayson Roberts = User.create!(username: "graysonroberts", password_digest: "iamgraysonroberts")
